...
Union:SETSIG As ULongInt:Type:SETBUSAK As ULong:SETHALT As ULong:SETREF As UBYTE:SETM1 As ULong:SETMREQ As UBYTE:SETIORQ As UBYTE:SETRD As UBYTE:SETWR As UBYTE:End Type:End Union
...
Dim Shared AS DOUBLE TM1,TM2,TM3,TM4
...
Dim Shared As Single DIVB=2.2,DIVC=1.7,DIVD=1.2,DIVA=9'DIVA=9
...
Dim Shared As ULong EXTL(32),TAKL(32),EPFX(8),CYC,ECYC
Dim Shared As ULongInt F1,F2,F3,F4
...
Dim Shared As String U$'ALL STRINGS
...
'2625,2558,2659 FPS FULL CYCLE VS 2400 NONOPT
'2035 ORIGINAL HERE VS FINAL 2625-2659 +30% GAIN
T3=32:T4=0:Do:TM1=Timer:T2=500:T1=T2:Do
SCRSHOW(4,0,0)
T1-=1:Loop While T1:TM2=Timer:TM3=T2/(TM2-TM1):T4+=TM3:

Print F1;":";F2;":";TM1;":";TM2;":";TM2-TM1;":";T2;":";TM3;":",,,,,T4/(33-T3):T3-=1:Loop While T3:Sleep
...
If X.INTDEC=0 Then 
	...
	If E0=1 Then SCRSHOW(4,0,0):Locate 4,100:Print ECYC;":";TM3;":";ECYC/TM3/50*3.5;":                            "
'	If E0=1 Then Locate 4,100:Print ECYC;":";TM3;":";ECYC/TM3/50*3.5;":                            "
...
'Sub SAVETEST()Static:Static As FILE Ptr filePtr:Static As UByte Ptr A1,A2,A3:filePtr = fopen("TEST_ZZ.BIN", "wb"):T1=fwrite(ZSTART,ZCUR-ZSTART,1, fileptr):fclose (fileptr):End Sub
'SAVETEST
