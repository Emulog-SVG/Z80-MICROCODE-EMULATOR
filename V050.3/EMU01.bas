#cmdline "-O 1 -w 3 -s console -RR -arch amd64 -asm intel -Wa --verbose"
#include "fbthread.bi"
...
If X.INTDEC=0 Then 
	...
	If E0=1 Then SCRSHOW(3,0,0):Locate 4,100:Print ECYC;":";TM3;":";ECYC/TM3/50*3.5;":                            "
