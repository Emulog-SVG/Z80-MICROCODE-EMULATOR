...
Q As ULong ' VISIBLE Q STATE
DSA As ULong ' PENDING Q STATE SET INSIDE ALU
DSC As ULong ' PENDING Q STATE SET BY SCF CCF
LUT As UByte Ptr
LEXT As ULong Ptr
LTAK As ULong Ptr
RL As ULong Ptr
...
Dim Shared As Const ULong IUADBC=1,IUADDE=2,IUAHL=3,IUAWZ=4,IUAAD=5,IUADSP=6,IUAIX=7,IUAIY=8,IUAPCI=9 ' SET ADDRESS BUS 
...
Dim Shared As Const ULong IUIM0=315,IUIM1=316,IUIM2=317,IULAQLD=318,IULTCPQ=319,IUBXORQ=320 
Dim Shared As Const ULong IUADDWZ=321,IUTADDQ=322,IULLRZ=324,IDONE=325,IPAR=326,IEXT=327      'RESERVED ,IUTADDQD=323
Dim Shared As Const ULong IUIFF=328,IUIMRQ=329,IUIMFET=330,IULWI=331,IULZ00=332
Dim Shared As Const ULong IUWBITQ=340,ISKIP6Z=341,IULWQLD=342,IUOFRXD=343,IUFHLZ=344,IULTCPX=345,IULLRW=346
